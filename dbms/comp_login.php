...
$sql = "SELECT * FROM company WHERE reg='$reg' AND cname='$name'";
      ...
      <div class="card-body">
        <form method="post" action="">
          <div class="input-group form-group">
            ...
            <input name="reg" class="form-control" placeholder="Registertion no" style="height: 40px"><br>
          ...
          <div class="input-group form-group">
            ...
            <input type="password" name="name" class="form-control" placeholder="Password" style="height: 40px">
          </div>
          <br>
